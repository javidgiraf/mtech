                ...
                <div class="card-body mt-4">
                    ...
                    <form class="row g-3" action="{{ route('admin.blogs.update', $blog->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" name="title" class="form-control @error('title') is-invalid @enderror" placeholder="{{ __('Title') }}" value="{{ old('title', $blog->title) }}">
                            @error('title')
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" name="sub_title" class="form-control" placeholder="{{ __('Sub Title') }}" value="{{ old('sub_title', $blog->sub_title) }}">
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <div id="dropbox" class="dropbox my-4">
                                ...
                                <div class="position-relative d-inline-block m-2">
                                    <img src="{{ asset('storage/blogs/'. $blog->image) }}" class="img-thumbnail" style="max-width: 300px; max-height: 300px; object-fit: cover;">
