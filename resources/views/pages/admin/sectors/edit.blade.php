        ...
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-body mt-4">
                    ...
                    <form class="row g-3" action="{{ route('admin.sectors.update', $sector->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="col-12">
                            <label for="title" class="form-label">{{ __('Title') }}<span class="text-danger">*</span></label>
                            <input type="text" name="title" class="form-control @error('title') is-invalid @enderror" placeholder="{{ __('Title') }}" value="{{ old('title', $sector->title) }}">
                            @error('title')
...
$("#sectorInputsTable").on("click", ".btn-plus", function() {
            let html = `
                <tr class="siNo">
                    <td>
                        <textarea type="textarea" name="content[]" class="form-control" placeholder="{{ __('Content') }}"></textarea>
                    </td>
                    <td></td>
                    <td scope="row">
                      <input type="file" name="sectorImage[]" class="form-control">
