                ...
                <div class="card-body mt-4">
                    ...
                    <form class="row g-3" action="{{ route('admin.testimonials.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" name="author_name" class="form-control @error('author_name') is-invalid @enderror" placeholder="{{ __('Author Name') }}" value="{{ old('author_name') }}">
                            @error('author_name')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="col-12">
                            <label for="photo">{{ __('Upload Photo') }} <span class="text-danger">*</span></label>
